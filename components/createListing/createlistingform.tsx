    ...
    <div className="form-container">
      ...
      <div className="steps-container">
        <div className={`step-content ${currentStep === 1 ? "active" : ""}`}>
          <div className="form-group">
            ...
            <h3 className="font-bold flex-1 pt-5 mb-2">Listing Details</h3>
              ...
              />
            <div className="form-group">
            <label htmlFor="property-type" className="label">Property Type</label>
            </div>
            <select id="property-type" name="property-type" className="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm mb-5">
        ...
        <div className="form-group items-center">
            ...
            />
            <label htmlFor="wifi" className="checkbox-label">Wi-Fi</label>
            </div>
            ...
            <input
              ...
              className="checkbox mr-10"
            />
            <label htmlFor="kitchen" className="checkbox-label">Kitchen</label>
            </div>
            ...
            <input
              ...
              className="checkbox mr-10"
            />
            <label htmlFor="washer" className="checkbox-label">Washer</label>
            </div>
          </div>
        ...
        <div className="form-group items-center">
            ...
            <input
              ...
              className="checkbox mr-10"
            />
            <label htmlFor="parking" className="checkbox-label">Parking</label>
            </div>
            ...
            <input
              ...
              className="checkbox mr-10"
            />
            <label htmlFor="ac" className="checkbox-label">A/C</label>
            </div>
            ...
            <input
              ...
              className="checkbox mr-10"
            />
            <label htmlFor="refrigerator" className="checkbox-label">Refrigerator</label>
            </div>
          </div>
        ...
        <div className={`step-content ${currentStep === 2 ? "active" : ""}`}>
          ...
          <div className="mt-5">
            ...
            <label htmlFor="buildingpermit" className="label mt-5"> Uploaded </label>
          </div>
        </div>
        ...
        <div
          ...
          <span className="absolute left-2 top-1/2 transform -translate-y-1/2 text-lg">₱</span> 
          <span className="absolute right-2 top-1/2 transform -translate-y-1/2 text-lg">/month</span>
          </div>
          ...
          />
          <label htmlFor="wifi" className="mr-8">Wifi</label>
          ...
          <label htmlFor="maintenance" className="mr-8">Maintenance</label>
            ...
            <input
              ...
              className="mr-3 leading-tight"
            />
            <label htmlFor="water" className="mr-8">Water</label>
            ...
            <input
              ...
              className="mr-3 leading-tight"
            />
            <label htmlFor="electricity" className="mr-8">Electricity</label>
          </div>
